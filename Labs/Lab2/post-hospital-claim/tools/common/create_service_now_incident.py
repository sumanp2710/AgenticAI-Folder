...
def create_service_now_incident(
    ...
    """
    This method creates a new ServiceNow incident with all the provided details.

    Parameters:
    - short_description: A brief summary of the incident.
    - description: Detailed information about the incident.
    - urgency: Urgency level should be one of (1 - High, 2 - Medium, 3 - Low, default is 2).

    :returns: The created incident details including incident number and other details.
    """
