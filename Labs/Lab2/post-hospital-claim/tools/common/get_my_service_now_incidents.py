...
def get_my_service_now_incidents(member_id: str = None) -> List[ServiceNowIncident]:
    """
    Fetch all ServiceNow that the user was the author of.

    Parameters:
    - member_id: Member Id associated with an incident
    ...
    if member_id is not None:
        query_params['caller_id'] = member_id
